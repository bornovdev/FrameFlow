      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categoriesLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group cursor-pointer" onClick={() => setLocation('/collections/prescription-frames')}>
              ...
              <div className="group cursor-pointer" onClick={() => setLocation('/collections/sunglasses')}>
                <div className="bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                  <img 
              ...
              <div className="group cursor-pointer" onClick={() => setLocation('/collections/reading-glasses')}>
                <div className="bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
                  <img 
